...
public class gameMain extends Application {
	...
	private void musicSet1(){
		URL soundUrl = getClass().getClassLoader().getResource("res/music.wav");
		System.out.println("Set first url =  "+soundUrl);
		if (soundUrl == null) {
			System.err.println("Error: music.wav not found! Make sure it's in src/res/ and res is marked as resources root.");
			return;
		}
